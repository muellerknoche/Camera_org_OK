 ...
 * @note Project doorspy for ME with ESP32 CAM and 5" CROWPANEL
 * @brief reads config data fom SD Card and handels WiFi sets up an access point
 * @date 21.11.2025 last change
 * @date 28.11.2025 mk from inlude/cd_card.h to src/cd_card.cpp 
 */
